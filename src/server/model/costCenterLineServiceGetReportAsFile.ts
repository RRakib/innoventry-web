...
export interface CostCenterLineServiceGetReportAsFile { 
    type?: CostCenterLineServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace CostCenterLineServiceGetReportAsFile {
