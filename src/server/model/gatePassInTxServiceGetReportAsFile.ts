...
export interface GatePassInTxServiceGetReportAsFile { 
    type?: GatePassInTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace GatePassInTxServiceGetReportAsFile {
