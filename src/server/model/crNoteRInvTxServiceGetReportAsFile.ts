...
export interface CrNoteRInvTxServiceGetReportAsFile { 
    type?: CrNoteRInvTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace CrNoteRInvTxServiceGetReportAsFile {
