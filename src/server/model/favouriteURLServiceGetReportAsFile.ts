...
export interface FavouriteURLServiceGetReportAsFile { 
    type?: FavouriteURLServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace FavouriteURLServiceGetReportAsFile {
