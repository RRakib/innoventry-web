...
export interface PriceListPrintingReportService2GetReportAsFile { 
    type?: PriceListPrintingReportService2GetReportAsFile.TypeEnum;
    arg?: PriceListPrintingArgument2;
}
export namespace PriceListPrintingReportService2GetReportAsFile {
