...
export interface ConsumptionTxServiceGetReportAsFile { 
    type?: ConsumptionTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ConsumptionTxServiceGetReportAsFile {
