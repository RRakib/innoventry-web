...
export interface StockLocationServiceGetReportAsFile { 
    type?: StockLocationServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace StockLocationServiceGetReportAsFile {
