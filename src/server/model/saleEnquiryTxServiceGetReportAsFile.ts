...
export interface SaleEnquiryTxServiceGetReportAsFile { 
    type?: SaleEnquiryTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace SaleEnquiryTxServiceGetReportAsFile {
