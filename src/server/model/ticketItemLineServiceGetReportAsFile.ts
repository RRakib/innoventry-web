...
export interface TicketItemLineServiceGetReportAsFile { 
    type?: TicketItemLineServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace TicketItemLineServiceGetReportAsFile {
