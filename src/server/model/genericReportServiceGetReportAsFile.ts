...
export interface GenericReportServiceGetReportAsFile { 
    type?: GenericReportServiceGetReportAsFile.TypeEnum;
    arg?: ReportInput;
}
export namespace GenericReportServiceGetReportAsFile {
