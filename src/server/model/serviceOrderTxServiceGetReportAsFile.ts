...
export interface ServiceOrderTxServiceGetReportAsFile { 
    type?: ServiceOrderTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ServiceOrderTxServiceGetReportAsFile {
