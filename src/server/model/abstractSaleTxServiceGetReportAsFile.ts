...
export interface AbstractSaleTxServiceGetReportAsFile { 
    type?: AbstractSaleTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace AbstractSaleTxServiceGetReportAsFile {
