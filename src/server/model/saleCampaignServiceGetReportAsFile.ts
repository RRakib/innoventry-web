...
export interface SaleCampaignServiceGetReportAsFile { 
    type?: SaleCampaignServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace SaleCampaignServiceGetReportAsFile {
