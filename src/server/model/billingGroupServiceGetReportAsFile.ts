...
export interface BillingGroupServiceGetReportAsFile { 
    type?: BillingGroupServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace BillingGroupServiceGetReportAsFile {
