...
export interface TaxableEntityServiceGetReportAsFile { 
    type?: TaxableEntityServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace TaxableEntityServiceGetReportAsFile {
