...
export interface StitchingItemServiceGetReportAsFile { 
    type?: StitchingItemServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace StitchingItemServiceGetReportAsFile {
