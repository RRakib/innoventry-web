...
export interface ServiceGroupServiceGetReportAsFile { 
    type?: ServiceGroupServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ServiceGroupServiceGetReportAsFile {
