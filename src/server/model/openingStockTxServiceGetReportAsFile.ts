...
export interface OpeningStockTxServiceGetReportAsFile { 
    type?: OpeningStockTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace OpeningStockTxServiceGetReportAsFile {
