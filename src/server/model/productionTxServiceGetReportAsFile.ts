...
export interface ProductionTxServiceGetReportAsFile { 
    type?: ProductionTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ProductionTxServiceGetReportAsFile {
