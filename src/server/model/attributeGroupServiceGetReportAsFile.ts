...
export interface AttributeGroupServiceGetReportAsFile { 
    type?: AttributeGroupServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace AttributeGroupServiceGetReportAsFile {
