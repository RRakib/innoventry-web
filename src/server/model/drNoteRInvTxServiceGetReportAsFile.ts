...
export interface DrNoteRInvTxServiceGetReportAsFile { 
    type?: DrNoteRInvTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace DrNoteRInvTxServiceGetReportAsFile {
