...
export interface OtherChargesServiceGetReportAsFile { 
    type?: OtherChargesServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace OtherChargesServiceGetReportAsFile {
