...
export interface ContactAddressServiceGetReportAsFile { 
    type?: ContactAddressServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ContactAddressServiceGetReportAsFile {
