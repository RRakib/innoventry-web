...
export interface ChequeDetailServiceGetReportAsFile { 
    type?: ChequeDetailServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ChequeDetailServiceGetReportAsFile {
