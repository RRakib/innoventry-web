...
export interface AbstractLedgerServiceGetReportAsFile { 
    type?: AbstractLedgerServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace AbstractLedgerServiceGetReportAsFile {
