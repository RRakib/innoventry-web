...
export interface GatePassOutTxServiceGetReportAsFile { 
    type?: GatePassOutTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace GatePassOutTxServiceGetReportAsFile {
