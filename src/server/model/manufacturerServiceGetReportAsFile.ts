...
export interface ManufacturerServiceGetReportAsFile { 
    type?: ManufacturerServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ManufacturerServiceGetReportAsFile {
