...
export interface StockSurplusTxServiceGetReportAsFile { 
    type?: StockSurplusTxServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace StockSurplusTxServiceGetReportAsFile {
