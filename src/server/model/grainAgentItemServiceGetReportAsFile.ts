...
export interface GrainAgentItemServiceGetReportAsFile { 
    type?: GrainAgentItemServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace GrainAgentItemServiceGetReportAsFile {
