...
export interface ItemSchemeLineServiceGetReportAsFile { 
    type?: ItemSchemeLineServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ItemSchemeLineServiceGetReportAsFile {
