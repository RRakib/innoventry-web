...
export interface StockSummaryReportService2GetReportAsFile { 
    type?: StockSummaryReportService2GetReportAsFile.TypeEnum;
    arg?: StockSummaryReportInput2;
}
export namespace StockSummaryReportService2GetReportAsFile {
