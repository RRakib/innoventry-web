...
export interface AbstractItemServiceGetReportAsFile { 
    type?: AbstractItemServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace AbstractItemServiceGetReportAsFile {
