...
export interface VoucherConfigServiceGetReportAsFile { 
    type?: VoucherConfigServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace VoucherConfigServiceGetReportAsFile {
