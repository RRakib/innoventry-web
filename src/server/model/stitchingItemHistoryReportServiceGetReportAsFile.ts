...
export interface StitchingItemHistoryReportServiceGetReportAsFile { 
    type?: StitchingItemHistoryReportServiceGetReportAsFile.TypeEnum;
    arg?: StitchingItemHistoryReportArgument;
}
export namespace StitchingItemHistoryReportServiceGetReportAsFile {
