...
export interface ItemDiscountServiceGetReportAsFile { 
    type?: ItemDiscountServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace ItemDiscountServiceGetReportAsFile {
