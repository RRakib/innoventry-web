...
export interface NotificationServiceGetReportAsFile { 
    type?: NotificationServiceGetReportAsFile.TypeEnum;
    arg?: ReportContext;
}
export namespace NotificationServiceGetReportAsFile {
