...
export interface PartnerItemLicenseReportServiceGetReportAsFile { 
    type?: PartnerItemLicenseReportServiceGetReportAsFile.TypeEnum;
    arg?: PartnerItemLicenseReportArg;
}
export namespace PartnerItemLicenseReportServiceGetReportAsFile {
