...
import { CashInHandReportServiceGetReportAsFile } from '../model/cashInHandReportServiceGetReportAsFile';
...
export class CashInHandReportServiceService {
    ...
    public getReportArg(body?: CashInHandReportInput, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<CashInHandReport>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReport_arg`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getReportAsFile(body?: CashInHandReportServiceGetReportAsFile, observe?: 'body', reportProgress?: boolean): Observable<FileResponse>;
    public getReportAsFile(body?: CashInHandReportServiceGetReportAsFile, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<FileResponse>>;
    public getReportAsFile(body?: CashInHandReportServiceGetReportAsFile, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<FileResponse>>;
    public getReportAsFile(body?: CashInHandReportServiceGetReportAsFile, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<FileResponse>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReportAsFile`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getReportFileStream(body?: CashInHandReportServiceGetReportFileStream, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReportFileStream`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getReportObj(body?: CashInHandReportServiceGetReportObj, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ICustomReport>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReportObj`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getReportObject(body?: CashInHandReportInput, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ICustomReport>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReportObject`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getReportTypeArg(body?: CashInHandReportServiceGetReportTypeArg, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<any>('post',`${this.basePath}/admin/accounting/CashInHandReportService/getReport_type_arg`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
