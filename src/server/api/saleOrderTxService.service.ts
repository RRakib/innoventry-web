...
import { SaleOrderTxServiceGetReportAsFile } from '../model/saleOrderTxServiceGetReportAsFile';
...
export class SaleOrderTxServiceService {
    ...
    public deleteObjectById(id?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<VoidResponse>('get',`${this.basePath}/admin/inventory/SaleOrderTxService/deleteObjectById`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getReportAsFile(body?: SaleOrderTxServiceGetReportAsFile, observe?: 'body', reportProgress?: boolean): Observable<FileResponse>;
    public getReportAsFile(body?: SaleOrderTxServiceGetReportAsFile, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<FileResponse>>;
    public getReportAsFile(body?: SaleOrderTxServiceGetReportAsFile, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<FileResponse>>;
    public getReportAsFile(body?: SaleOrderTxServiceGetReportAsFile, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<FileResponse>('post',`${this.basePath}/admin/inventory/SaleOrderTxService/getReportAsFile`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
