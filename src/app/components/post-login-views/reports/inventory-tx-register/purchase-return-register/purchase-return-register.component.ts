...
import { InventoryTxReportArgument, InventoryTxReportServiceService, InventoryTxReportGroupLine, InventoryTxReportServiceGetReportAsFile } from 'src/server';
...
export class PurchaseReturnRegisterComponent implements OnInit {
  ...
  public purchaseReturnRegisterForm!: FormGroup;
  columns : Object[];
  ...
  constructor(private breakpointObserver: BreakpointObserver,private customDateAdapterService  : CustomDateAdapterService,
    ...
    private commonUtils : CommonUtils, private downloadService : DownloadService) { 
      ...
      this.purchaseReturnRegisterForm = this.formBuilder.group({      
  ...
  ngOnInit(): void {
    ...
    this.data = [];
    this.getPurchaseReturnRegisterReport();
  ...
  getPurchaseReturnRegisterReport(): void{
    this.inputModel = {};
    this.data = [];

    this.inputModel.dateFrom = this.purchaseReturnRegisterForm.controls["startDate"].value;
    this.inputModel.dateTo = this.purchaseReturnRegisterForm.controls["endDate"].value;
    this.inputModel.showDetail = this.purchaseReturnRegisterForm.controls["isItemDetailRequired"].value;

    this.inputModel.txTypeClassName = "in.solpro.nucleus.inventory.model.IPurchaseReturnOrderTx";
  ...
  createNewPurchaseReturnnTx() : void{
    this.router.navigate(['main/transaction/purchaseReturn/new']);
  }
  ...
  download(type: string) : void {
    ...
    modelArg.dateFrom = this.purchaseReturnRegisterForm.controls["startDate"].value;
    modelArg.dateTo = this.purchaseReturnRegisterForm.controls["endDate"].value;
    modelArg.showDetail = this.purchaseReturnRegisterForm.controls["isItemDetailRequired"].value;    
    modelArg.txTypeClassName = "in.solpro.nucleus.inventory.model.IPurchaseReturnOrderTx";
